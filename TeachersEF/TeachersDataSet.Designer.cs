...
namespace TeachersEF {
    ...
    public partial class TeachersDataSet : global::System.Data.DataSet {
        ...
        public partial class TeacherDataTable : global::System.Data.TypedTableBase<TeacherRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public TeacherRow AddTeacherRow(string FirstName, string LastName, string Address, byte[] Image) {
        ...
        public partial class TeacherRow : global::System.Data.DataRow {
            ...
            public byte[] Image {
                get {
                    try {
                        return ((byte[])(this[this.tableTeacher.ImageColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace TeachersEF.TeachersDataSetTableAdapters {
    ...
    public partial class TeacherTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Teacher] WHERE (([TeacherId] = @Original_TeacherId) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Teacher] ([FirstName], [LastName], [Address], [Image]) VALUES " +
                "(@FirstName, @LastName, @Address, @Image);\r\nSELECT TeacherId, FirstName, LastNam" +
                "e, Address, Image FROM Teacher WHERE (TeacherId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Teacher] SET [FirstName] = @FirstName, [LastName] = @LastName, [Address] = @Address, [Image] = @Image WHERE (([TeacherId] = @Original_TeacherId) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)));
SELECT TeacherId, FirstName, LastName, Address, Image FROM Teacher WHERE (TeacherId = @TeacherId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::TeachersEF.Properties.Settings.Default.TeachersConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT TeacherId, FirstName, LastName, Address, Image FROM dbo.Teacher";
        ...
        public virtual int Delete(int Original_TeacherId, string Original_FirstName, string Original_LastName, string Original_Address) {
        ...
        public virtual int Insert(string FirstName, string LastName, string Address, byte[] Image) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(string FirstName, string LastName, string Address, byte[] Image, int Original_TeacherId, string Original_FirstName, string Original_LastName, string Original_Address, int TeacherId) {
            if ((FirstName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string Address, byte[] Image, int Original_TeacherId, string Original_FirstName, string Original_LastName, string Original_Address) {
            return this.Update(FirstName, LastName, Address, Image, Original_TeacherId, Original_FirstName, Original_LastName, Original_Address, Original_TeacherId);
        }
    }
